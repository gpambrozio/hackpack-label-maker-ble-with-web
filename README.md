...
`test-client.html` is a tiny page that runs in Chrome/Edge on desktop and Android. It talks to the label maker over BLE.

Steps:
- Open `test-client.html` (double‑click the file or drag it into a browser tab)
